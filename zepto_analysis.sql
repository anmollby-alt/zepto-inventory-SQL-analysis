...
-- FIX: added missing comma after category; fixed typo availableQuantity
SELECT category,
...
-- FIX: added missing comma after discountedSellingPrice; removed invalid '100g' literal
...
-- Q7: Group products by weight category (Low / Medium / Bulk)
-- FIX: added missing comma after weightInGms
